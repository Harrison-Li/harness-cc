...
class ToolExecution:
    """
    Execution message passing between LLM and tools.
    """
    name: str
    source_hint: str
    payload: str # JSON string, how the tool would be invoked (parameters)
    handled: bool # whether the tool was invoked
